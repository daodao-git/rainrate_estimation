        ...
        rows.append(
            {
                ...
                "raw_RMSE": mea_metrics["raw_rmse"],
                "raw_MAE": mea_metrics["raw_mae"],
                "raw_Bias": mea_metrics["raw_bias"],
                "linear_RMSE": mea_metrics["linear_rmse"],
                "linear_MAE": mea_metrics["linear_mae"],
                "linear_Bias": mea_metrics["linear_bias"],
                "ridge_RMSE": mea_metrics["ridge_rmse"],
                "ridge_MAE": mea_metrics["ridge_mae"],
                "ridge_Bias": mea_metrics["ridge_bias"],
